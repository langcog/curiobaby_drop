...
abstract: >
     ...
     comparisons. We children's choices (N=66; 3-7 years of age) to those of adults (N=XX), and find
...
### Participants
Participants were 44 adults recruited online via Amazon Mechanical Turk who were paid $1 for their participation.
...
They were than asked to choose which toy to drop the torus on, and prompted to choose the most interesting or surprising combination.
...
We analyzed data from the `r Nad` adults who completed the experiment and got at least 3 of the 4 catch trials correct.
...
```{r fig1-sets, fig.env = "figure", fig.pos = "h", fig.align='center', fig.width=3.25, fig.height=3, set.cap.width=T, num.cols.cap=1, fig.cap = "Children online study screen configuration."}
img <- png::readPNG("figs/online-child-practice-trial")
grid::grid.raster(img)
```
