...
After examining children's and adult's preferences, we tested the predictive power of a variety of heuristic features derived from simulations of this task using a 3D environment.
To preview our results, we found a surprising amount of consistency in how both children and adults chose to explore the relationships between different objects -- but that this consistency was not easily explained by any of simple heuristic features that we tested. 
We propose that these kinds of physical exploration task are a promising tested for adjudicating between different embodied models of curiosity.
