...
```{r fig1-sets, fig.env = "figure", fig.pos = "h", fig.align='center', fig.width=3.25, fig.height=3, set.cap.width=T, num.cols.cap=1, fig.cap = "Set of 3D objects used for dropping and as targets."}
...
Participants were told they would be helping choose which toys to include in a new set of children's blocks in order to make them the most interesting.
