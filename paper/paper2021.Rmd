...
[ToDo: describe *skillsiness*]
We measure each of these features in 250 simulations of each possible drop in the experiment, and then use the resulting metrics to generate relative preferences for each of the drop choices on each trial. 
...
```{r human-vs-model-relational-choices, fig.env = "figure", fig.pos = "h", fig.align='center', fig.width=3.25, fig.height=5.5, set.cap.width=T, num.cols.cap=1, fig.cap = "Comparison of model's vs. participants' choices for each type of trial, with bootstrapped 95\\% confidence intervals."}
pos = position_dodge(width = .9)
