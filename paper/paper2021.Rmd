...
author-information: > 
    ...
    {\large \bf Michael Lingelbach}$^{1,3}$, {\large \bf Daniel M. Bear}$^{1,3}$, {\large \bf Daniel L. K. Yamins}$^{1,3}$, \and {\large \bf Michael C.~Frank}$^1$ \\ 
...
However, relatively little work has either examined what types of physical interactions children are most interested in testing, or linked children's actions to formal theories of exploration or of physics learning.
...
This was done to ensure that they understood the consequences of the choice they made, although it was pointed out to them that the video they saw showed only one possible outcome.
After the example video, participants were given a sequence of 20 more drop trials asking them to choose which toy (X or Y) they would like to drop object Z on.
...
Participant exclusions were made based on cases where i) the participant did not complete more than half of the trials or ii) the parent did not consent for video recording of the session. 
After exclusions, results from `r Nch` children were analyzed, including `r age[1,]$N` 3-year-olds, `r age[2,]$N` 4-year-olds, `r age[3,]$N` 5-year-olds, `r age[4,]$N` 6-year-olds, and `r age[5,]$N` 7-year-olds.
