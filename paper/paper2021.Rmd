...
At a glance, these results seem to support the hypothesis that "children are noisy adults" in this task and suggests some consistency in the trial-level effects across development. 
...
-->
In future work, we aim to examine the development of curiosity in such curious artificial agents, and compare whether these agents behave similarly to people and "drop it like it's hot" [@Snoop].
