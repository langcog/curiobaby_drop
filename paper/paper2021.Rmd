...
Figure 5 shows adults' (Experiment 1) vs. children's (Experiment 2) choice proportions for the target relations, colored by relation type (visualizing the same data presented in Table 2, but with 95% CIs).
...
For example, while the best-fitting feature, *Pr(support)*, captured both adults' and children's overall mean preference for the designed target relations, it explained no trial-level variation and was in fact negatively correlated with people's choices.
