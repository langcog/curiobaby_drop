...
Our computational theory is inspired by classic verbal theories that posited that curiosity-driven behavior was the consequence of attentional capture by novel stimuli [e.g., @Berlyne1954,@Fantz1964], as well as other verbal theories proposing to explain curiosity-driven behavior as the manifestation of learners' preferences for stimuli that are "moderately discrepant" in comparison to our mental representations, and thereby provide opportunities to learn [@Kinney1976]. Recent studies have provided empirical support for this basic idea: XX-old infants are sensitive to stimulus complexity and prefer to look at moderately complex stimuli rather than overly simple or overly complex stimuli; @Kidd2012; @Kidd2014].
